...
function GitHubIcon(props) {
  return (
    <svg
      ...
      strokeWidth="1.5"
      stroke="currentColor"
      className="h-6 w-6 text-rose-300 dark:text-rose-300 fill-rose-200 dark:fill-rose-100"
    >
      <path
        strokeLinecap="round"
  ...
  return (
    ...
    >
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link
          href="https://www.paypal.com/donate/?business=PWDGWE6KYXJDL&no_recurring=0&item_name=%F0%9F%98%8D+Thank+you+for+supporting+me%21+I+love+engineering+new+content+and+your+donation+helps+me+keep+doing+that.&currency_code=USD"
          className="group"
          aria-label="GitHub"
        >
